...
fn validate_comment(relative: &str) -> Vec<String> {
    let file = common::project_file("require_english_comment", relative);
...
#[test]
fn java_block_単一行ブロックコメントに日本語がある() {
    expect_comment_violation(
...
#[test]
fn java_block_複数行ブロックコメントに日本語がある() {
    expect_comment_violation(
...
#[test]
fn java_block_コード行中のブロックコメントに日本語がある() {
    expect_comment_violation(
...
#[test]
fn python_line_コメント行に日本語コメントがある() {
    expect_comment_violation(
...
#[test]
fn python_line_コード行末に日本語コメントがある() {
    expect_comment_violation(
...
#[test]
fn python_block_単一行ブロックコメントに日本語がある() {
    expect_comment_violation(
...
#[test]
fn python_block_複数行ブロックコメントに日本語がある() {
    expect_comment_violation(
...
#[test]
fn python_block_コード行中のブロックコメントに日本語がある() {
    expect_comment_violation(
...
#[test]
fn rust_block_単一行ブロックコメントに日本語がある() {
    expect_comment_violation(
...
#[test]
fn rust_block_複数行ブロックコメントに日本語がある() {
    expect_comment_violation(
...
#[test]
fn rust_block_コード行中のブロックコメントに日本語がある() {
    expect_comment_violation(
